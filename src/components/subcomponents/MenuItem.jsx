...
const MenuItem = ({ menu }) => {
  ...
  return (
    <div className="featured-card flex flex-col justify-between">
      ...
      <div className="flex flex-col p-[0.625rem] gap-y-2">
        <Link href={`/menu/${menu.slug}`}>
          <h5 className="capitalize font-bold text-main-600 hover:text-main-800">{menu.name}</h5>
        </Link>
        <div className="ratings flex items-center gap-2">
          <span className="bi bi-star-fill text-main-500"></span>
          <span className="bi bi-star-fill text-main-500"></span>
          <span className="bi bi-star-fill text-main-500"></span>
          <span className="bi bi-star-fill text-main-500"></span>
          <span className="bi bi-star-fill text-main-500"></span>
      ...
      <div className="flex flex-col p-[0.625rem] gap-y-2">
        ...
        <div className="flex flex-col sm:items-center sm:justify-between sm:flex-row gap-3">
          ...
          <button 
            className="inline-flex items-center justify-center gap-2 btn btn-main py-2 px-3 text-sm"
